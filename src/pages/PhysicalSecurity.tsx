...
我們提供完整的合規服務套件，包括滲透測試、漏洞掃描、SIEM監控、日誌存儲和安全意識培訓等服務，幫助企業全面符合該條例的要求，確保關鍵基礎設施的網絡安全。`,
    ...
    en: {
      ...
      description: `**Ordinance Overview**
...
**Category 1:** Infrastructure for delivering essential services in Hong Kong in the following specified sectors:
• Energy
...
**Category 2:** Any other infrastructure, the damage, loss of functionality or data leakage of which may hinder or otherwise substantially affect the maintenance of critical societal or economic activities in Hong Kong.

The Government has stated major sports and performance venues, research and development parks as being examples of infrastructure in this category.

**Exclusions:** The Ordinance does not apply to certain essential infrastructure/services that are operated by the government – e.g. water supply, drainage and emergency relief.
...
重要インフラ（コンピュータシステム）保護条例は、2025年3月19日に香港立法会で可決されました。2026年1月1日に施行される予定です。
...
**カテゴリー1：** 香港で必須サービスを提供するインフラで、以下の指定分野をカバーします：
• エネルギー
• 情報技術
• 銀行・金融サービス
• 航空輸送
...
**カテゴリー2：** その他のインフラで、損傷、機能喪失、またはデータ漏洩が香港の重要な社会的または経済的活動の維持を妨げるか、その他大幅に影響を与える可能性があるもの。

政府は、主要なスポーツ・パフォーマンス会場、研究開発パークをこのカテゴリーのインフラの例として挙げています。
