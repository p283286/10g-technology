...
interface SecurityDashboardGalleryProps {
...
const SecurityDashboardGallery: React.FC<SecurityDashboardGalleryProps> = ({
  dashboardImages,
  dashboardTitle,
      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-4xl mx-auto">
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <div className="relative overflow-hidden rounded-lg shadow-md cursor-pointer hover:shadow-xl transition-all duration-300 group">
                      <img 
                        src={img} 
                        alt={`Security Dashboard ${index + 1}`} 
                  ...
                  <DialogContent className="max-w-5xl w-full p-1">
                    <img 
                      src={img} 
                      alt={`Security Dashboard ${index + 1} (Full Size)`} 
          ...
          <div className="mt-12 text-center">
            ...
            >
              {/* Unlike SIEMDashboardGallery, we'll use a generic message as this prop isn't passed */}
...
export default SecurityDashboardGallery;
